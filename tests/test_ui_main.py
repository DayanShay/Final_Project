...
def test_delete_book_unauthorize(get_api_unautho, get_authirized):
    api = get_api_unautho
...
def test_post_account(get_api_unautho, make_api_user_dto):
...
# def test_refresh_token(get_api_unautho, make_log_in_admin):
#     User_Login = make_log_in_admin
#     res = get_api_unautho.Account.post_refresh_token(data=User_Login)
...
def test_get_authors(get_api_unautho):
    api = get_api_unautho.authors
    res = api.get_authors()
    LOGGER.info(f"{res}")

def test_post_authors(get_api_unautho, create_authors_dto, get_authirized):
...
def test_get_authors_by_id(get_api_unautho, id="1"):
    api = get_api_unautho.authors
    res = api.get_authors_by_id(id=id)
    LOGGER.info(f"{res}")

def test_put_authors_by_id(get_api_unautho, update_authors_dto):
...
def test_delete_authors_by_id(get_api_unautho, get_authirized):
    api = get_api_unautho
    api.update_session_header(get_authirized)
...
def test_search_authors_by_text(get_api_unautho):
    api = get_api_unautho.authors
...
def test_get_books(get_api_unautho):
    api = get_api_unautho.books
    books = api.get_books()
    print(books)

def test_post_books(get_api_unautho, get_create_book_dto, get_authirized):
    api = get_api_unautho
    api.update_session_header(get_authirized)
    books_api = api.books
...
def test_delete_books_by_id(get_api_unautho):
    books_api= get_api_unautho.books
...
def test_get_books_by_author_id(get_api_unautho):
    api  = get_api_unautho.books
    get_books_by_author_id_res = api.get_books_by_author_id(authorid="1")
    print(get_books_by_author_id_res)

def test_put_purchese_by_books_id(get_api_unautho, get_authirized):
    api = get_api_unautho
    api.update_session_header(get_authirized)
